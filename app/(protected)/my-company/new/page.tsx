...
export default function NewCompanyPage() {
  ...
  const handleSuccess = (result: {
    ...
    // If a company was created, switch to it in the global org context
    if (result.companyId) {
      setSelectedOrg(result.companyId);
    }
  };
          ...
          <Card className="card-professional">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 bg-muted/50 rounded-lg text-sm text-muted-foreground">
                {submitResult.action === "create" ? (
                  <p>
                    Your company has been submitted for review. A platform
                    administrator will review your submission and approve it
                    soon. You&apos;ll receive a notification once your company
                    is active.
                  </p>
                ) : (
                  <p>
                    Your request to join has been sent to the company
                    administrators. Once approved by the company admin and
                    platform admin, you&apos;ll be added as a member of the
                    company.
                  </p>
                )}
              </div>

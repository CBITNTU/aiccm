...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
    ...
    <div style="background: #f8fafc; border-left: 4px solid #2563EB; padding: 15px; margin: 20px 0; border-radius: 0 6px 6px 0;">
    ...
    <p style="font-size: 12px; color: #6b7280;">If the button doesn't work, copy and paste this link into your browser:<br><a href="${verificationLink}" style="color: #2563EB; word-break: break-all;">${verificationLink}</a></p>

    <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 30px 0;">

    <p style="color: #999; font-size: 12px; margin: 0;">
      This email was sent by <a href="${platformUrl}" style="color: #2563EB;">${platformName}</a>. If you didn't create an account, please ignore this email.
    </p>
  </div>
</body>
</html>

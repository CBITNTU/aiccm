...
export function RecommendedPartners({ partners, onAddPartner }: RecommendedPartnersProps) {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground text-center py-8">
            No partner recommendations available. Run the analysis to get recommendations.
          </p>
        </CardContent>
      </Card>
    );
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    size="sm"
                    onClick={() => onAddPartner(partner.id)}
                  >
              ...
              {partner.matchingCompetencies && partner.matchingCompetencies.length > 0 && (
                <div className="mb-2">
                  <div className="text-sm font-medium mb-1">Matching Competencies:</div>

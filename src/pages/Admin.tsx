...
import { BarChart3, Building2, FileText, Users2, Settings, Database, Activity, AlertCircle } from "lucide-react";
...
const Admin = () => {
  ...
  const recentActivity = [
    { type: "Company", action: "Onboarded", entity: "Midlands Construction Ltd", time: "2 hours ago" },
    { type: "Tender", action: "Published", entity: "Leicester Sports Complex", time: "3 hours ago" },
    { type: "VO", action: "Formed", entity: "Nottingham Infrastructure Group", time: "5 hours ago" },
    { type: "System", action: "AI Model Updated", entity: "GPT-4 Turbo", time: "6 hours ago" },
  ];
                    ...
                    <div key={service.service} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <div className="flex items-center space-x-2">
                          {service.status === "Issues" && <AlertCircle className="w-4 h-4 text-accent" />}

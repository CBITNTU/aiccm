-- Replace taxonomies with EIC (European Innovation Council) standard taxonomy.
-- Level 1 = 15 categories, Level 2 = subcategories. No level 3.
-- This is the basic taxonomy; we do not use dynamic taxonomy.

-- Clear existing taxonomy links (FKs reference taxonomies)
DELETE FROM public.tender_taxonomies;
DELETE FROM public.company_taxonomies;
DELETE FROM public.taxonomies;
...
INSERT INTO public.taxonomies (name, level, description) VALUES
  ...
  ('Transport and Mobility', 1, 'EIC taxonomy category');

...
export default function AdminPage() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const completedProfiles = companiesData.filter(
        (c) =>
          c.description &&
      ...
      setOnboardingMetrics({
        totalOnboarded: companiesData.length,
        completedProfiles,
        incompleteProfiles,
        completionRate,
        avgCompletionTime,
          ...
          <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="w-full bg-muted rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${
                            dataQuality.dataCompletenessRate >= 70 ? "bg-primary" : "bg-accent"
                          }`}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-green-600">
                        {dataQuality.companiesWithAIAnalysis}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Without AI Analysis</span>
                      <span className="font-semibold text-orange-600">
                        {dataQuality.companiesWithoutAIAnalysis}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Latest platform activity and changes</CardDescription>
              </CardHeader>
              <CardContent>

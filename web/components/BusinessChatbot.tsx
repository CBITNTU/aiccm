...
export function BusinessChatbot({ companyData }: BusinessChatbotProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hi! I'm your business advisor. I can help you navigate the platform, understand tender opportunities, and provide business advice. What would you like to know?",
      isBot: true,
      timestamp: new Date(),
    },
  ]);
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="mb-2 bg-background border border-border rounded-lg shadow-lg p-3 max-w-48 animate-pulse">
          <p className="text-xs text-muted-foreground">
            Need help? Ask me about platform features or business advice!
          </p>
        </div>
        <Button
